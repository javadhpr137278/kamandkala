                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="etitle" class="form-control @error('etitle') is-invalid @enderror" value="{{ old('etitle', $category->etitle) }}">
                                @error('etitle')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if($category->image && Storage::disk('public')->exists($category->image))
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            ...
                                            <br>
                                            <small class="text-muted">برای تغییر تصویر، فایل جدید را انتخاب کنید</small>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="imageInput">انتخاب فایل جدید</label>
                                    @error('image')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
